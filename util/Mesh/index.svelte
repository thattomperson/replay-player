<script>
	...
	import { get_scene, get_layer, get_parent } from '@sveltejs/gl/internal/index.mjs';
	import { process_color } from '@sveltejs/gl/internal/utils.mjs';
	import Material from '@sveltejs/gl/scene/Mesh/Material.mjs';
	import vert_default from '@sveltejs/gl/scene/Mesh/shaders/default/vert.glsl';
	import frag_default from '@sveltejs/gl/scene/Mesh/shaders/default/frag.glsl';
